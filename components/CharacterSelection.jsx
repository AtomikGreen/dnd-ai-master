...
const PREGENERATED = [
  {
    ...
    weapons: [
      { weaponId: "epee_longue", name: "Épée longue", attackBonus: 5, damageDice: "1d8", damageBonus: 3 },
      { weaponId: "arbalete_legere", name: "Arbalète légère", attackBonus: 3, damageDice: "1d8", damageBonus: 1 },
    ],
    fighter: {
  ...
  },
  {
    ...
    inventory: ["Bâton", "Dague", "Sac d'érudit", "Focaliseur arcanique", "Grimoire", "Potion de soins"],
    weapons: [
      { weaponId: "baton", name: "Bâton", attackBonus: 2, damageDice: "1d6", damageBonus: 0 },
      { weaponId: "dague", name: "Dague", attackBonus: 4, damageDice: "1d4", damageBonus: 2 },
    ],
    wizard: {
      spellbook: [
        "Armure de mage",
  ...
  },
  {
    ...
    type: "player",
    controller: "player",
    name: "Aldéric Main-de-Mercy",
    entityClass: "Clerc",
    race: "Humain (Standard)",
    level: 1,
    alignment: "Neutre Bon",
    background: "Acolyte",
    backgroundFeature: "Abri du fidèle",
    ideals:
      "Charité. Je partage ce que je peux avec ceux qui en ont besoin, quelles que soient les circonstances.",
    bonds:
      "Le petit sanctuaire où j'ai grandi compte plus pour moi que tout trésor — je dois le protéger.",
    flaws:
      "Je me sens coupable de ne pas pouvoir soulager toute la misère du monde, et cela me ronge.",
    description:
      "Humain solidement bâti, tonsure soignée et symbole sacré usé poli par des années de prières. Voix douce mais regard déterminé.",
    initiative: 0,
    speed: "30 ft",
    visible: true,
    isAlive: true,
    ...
    equipment: {
      armor: "Cotte d'écailles",
      mainHand: "Masse d'armes",
      offHand: "Bouclier",
      bottes: null,
      cape: null,
      tete: null,
    ...
    stats: { FOR: 14, DEX: 11, CON: 15, INT: 9, SAG: 16, CHA: 13 },
    skillProficiencies: ["Médecine", "Histoire", "Perspicacité", "Religion"],
    proficiencies: ["Médecine", "Histoire", "Perspicacité", "Religion"],
    features: [
      "Incantation",
      "Domaine divin",
      "Disciple de la vie",
    ...
    classFeatures: ["Incantation", "Domaine divin"],
    languages: ["Commun", "Céleste", "Draconique"],
    selectedSpells: [
      "Assistance",
      "Flamme sacrée",
      "Lumière",
    ...
    weapons: [
      { weaponId: "masse_darmes", name: "Masse d'armes", attackBonus: 4, damageDice: "1d6", damageBonus: 2 },
      { weaponId: "arbalete_legere", name: "Arbalète légère", attackBonus: 2, damageDice: "1d8", damageBonus: 0 },
    ],
    cleric: {
      divineDomain: "Vie",
      preparedSpells: ["Mot de guérison", "Détection de la magie", "Injonction"],
      domainSpells: ["Bénédiction", "Soins"],
    },
  },
  {
    id: "pre-4",
    type: "player",
    controller: "player",
    name: "Mira Ombre-Rousse",
    entityClass: "Roublard",
    race: "Halfelin Pied-Léger",
    level: 1,
    alignment: "Chaotique Neutre",
    background: "Criminel",
    backgroundFeature: "Accès au réseau criminel",
    ideals:
      "Liberté. Les chaînes sont faites pour être brisées, qu'il s'agisse de tyrans, de lois ou de conventions.",
    bonds:
      "Je dois une dette impayable à la personne qui m'a sortie de la rue — un jour je la rembourserai.",
    flaws:
      "Quand un plan ne tourne pas rond, je panique et cherche la sortie la plus rapide, quitte à abandonner les autres.",
    description:
      "Halfeline souriante aux taches de rousseur et aux mains trop rapides pour l'œil. Cape sombre, bottes souples, dagues dissimulées.",
    initiative: 3,
    speed: "25 ft",
    visible: true,
    isAlive: true,
    ...
    hitDiceTotal: 1,
    hitDiceRemaining: 1,
    stats: { FOR: 8, DEX: 17, CON: 14, INT: 13, SAG: 12, CHA: 10 },
    skillProficiencies: ["Discrétion", "Tromperie", "Investigation", "Perception"],
    proficiencies: ["Discrétion", "Tromperie", "Investigation", "Perception"],
    features: [
      "Chanceux",
      "Brave",
      "Agilité halfeline",
      ...
      "Attaque sournoise",
      "Jargon des voleurs",
      "Accès au réseau criminel",
    ],
    classFeatures: ["Expertise", "Attaque sournoise", "Jargon des voleurs"],
    ...
    weapons: [
      { weaponId: "rapière", name: "Rapière", attackBonus: 5, damageDice: "1d8", damageBonus: 3 },
      { weaponId: "arc_court", name: "Arc court", attackBonus: 5, damageDice: "1d6", damageBonus: 3 },
      { weaponId: "dague", name: "Dague", attackBonus: 5, damageDice: "1d4", damageBonus: 3 },
    ],
    rogue: {
      expertise: {
