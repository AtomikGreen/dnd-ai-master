...
function buildEnemySystemPrompt() {
  return [
    ...
    "",
    "Format obligatoire:",
    '{ "thought_process": "court raisonnement tactique", "actions": [ { "type": "action|bonus_action|movement", "name": "nom exact de l arme/sort/capacité", "target": "id_cible" } ] }',
    "",
    "Règles:",
    ...
    "  2) action avec le nom exact de l'arme, du sort ou de la capacité offensive à utiliser (optionnel),",
